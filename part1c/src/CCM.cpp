		...
		for (int b = 0; b < fNu; b++)
			for (int i = 0; i < fA; i++)
				...
				{	
					...
					Permute(i1, i2, 0, 1); Permute(i3, i4, 0, 1); // - b a i j
					fHamil(a, b, i, j) +=
						- 0.5 * fVhhpp.Prod4x4(fTpphh, i1 , i2).Prod4x4(fTpphh, i3, i4)(a, b, i, j);
					
					Permute(i3, i4, 2, 3); Permute(i1, i2, 2, 3); // b a j i
					fHamil(a, b, i, j) +=
						 0.5 * fVhhpp.Prod4x4(fTpphh, i1 , i2).Prod4x4(fTpphh, i3, i4)(a, b, i, j);
					
					Permute(i1, i2, 0, 1); Permute(i3, i4, 0, 1); // - a b j i
					fHamil(a, b, i, j) +=
						- 0.5 * fVhhpp.Prod4x4(fTpphh, i1 , i2).Prod4x4(fTpphh, i3, i4)(a, b, i, j);
					...
					Permute(i2, i3, 2, 3); Permute(i1, i5, 2, 3); // a b j i
					fHamil(a, b, i, j) +=
						- 0.5 * fTpphh.Prod4x2(fVhhpp.Prod4x4s3(fTpphh, i1 , i2), i3, i5)(a, b, i, j);
					...
					Permute(i2, i3, 0, 1); Permute(i1, i5, 0, 1); // b a i j
					fHamil(a, b, i, j) +=
						- 0.5 * fTpphh.Prod4x2(fVhhpp.Prod4x4s3(fTpphh, i1 , i2), i3, i5)(a, b, i, j);					
					//getchar();
					//cout << "#5" << endl;
